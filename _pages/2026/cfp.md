...
- demonstration of issues with evaluation metrics (e.g. F1, BLEU, LLM-as-judge), which prevent their usage for fair comparison of methods;  

- failures to follow policies (e.g. the method is supposed to be optimized to avoid X, but it still produces X)

- unforeseen consequences in agentic systems
...
In 2026, we will invite the authors of accepted negative results papers to nominate the specific work reporting the original positive results. The goal is to organize joint discussion sessions, so that the community can learn the most from the specific insightful failure.
...
The workshop will run its own review process, and papers can be submitted directly to the workshop by June 25th, 2026. It is also possible to commit a paper accompanied with reviews from the ACL Rolling Review system by June 25th, 2026. The submission deadline for ARR papers follows the ACL RR calendar. Both research papers and abstracts must follow the ACL two-column format. Official style sheets: https://github.com/acl-org/acl-style-files
...
- Aleksandr Drozd, AI-KIP  

- Arjun Reddy Akula, Google DeepMind  

- Raphael Shu, Acenta AI 

- Anna Rogers, ITU Copenhagen

- Xiaoli Shen, Microsoft

- Salvatore Giorgi, IR

- Adrian Benton, Google Research
